...
function getCursos(inicio, fim, postid){
	...
	var cursos;
	var url = '/shumi/dataentities/CR/search/?_fields=id,DiaCurso,MesCurso,Thumbnail,courseStart,courseEnd,AnoCurso,permaLink,HoraInicioCurso,HoraFimCurso,NomeCurso,FullCurso,PalestranteCurso&_sort=courseStart DESC';
	var _headers = {
